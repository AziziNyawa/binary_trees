 ...
 * @tree: A pointer to the root node of the tree to measure length
 *
 ...
 * @lo: The value of the smallest node in the lsit visited thus far.
 * @hi: The value of the largest node in the lsit visited this far.
 *
